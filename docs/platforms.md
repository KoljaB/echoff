...
Planned. A backend should use ScreenCaptureKit or CoreAudio Process Taps for
system audio and CoreAudio for the microphone. It must handle permissions and
bridge both streams onto a common monotonic timeline.
